    ...
    return {
        ...
        columnsDefinition: [
            ...
            },
            {
                ...
                valueSetter: (value, row) => { return { ...row, orderStatus: value !== -1 ? orderStatus.find(entry => entry.id_status === value) : null }},
            },
            {
                field: "orderPriority",
                headerName: "PRIORITY",
                ...
                valueSetter: (value, row) => { return { ...row, orderPriority: value !== -1 ? priorities.find(entry => entry.id_priority === value) : null }},
            },
            {
